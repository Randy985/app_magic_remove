...
class RemoveBgPage extends StatefulWidget {
  ...
  @override
  State<RemoveBgPage> createState() => _RemoveBgPageState();
}

class _RemoveBgPageState extends State<RemoveBgPage> {
  final controller = RemoveBgController();
  File? imageFile;
  ...
  // Botón de acción con icono y color personalizados
  Widget _actionBtn({
